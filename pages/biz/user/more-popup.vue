	...
	<uni-popup ref="popupRef" type="bottom" safeArea>
		<view class="container">
			<uni-list :border="false">
				<uni-list-item v-if="hasPerm('mobileBizUserEdit')" title="编辑" class="item" :clickable="true" @click="edit">
				</uni-list-item>
				<uni-list-item v-if="hasPerm('mobileBizUserDelete')" title="刪除" class="item" :clickable="true" @click="del">
				</uni-list-item>
